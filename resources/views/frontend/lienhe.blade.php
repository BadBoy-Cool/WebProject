                ...
                <div class="row align-items-center">
                    <div class="col-lg-4">
                        <div class="contact-info-content mb-30 rmb-55">
                            ...
                            <p>Đội ngũ hỗ trợ tận tâm của chúng tôi luôn sẵn sàng giúp đỡ bạn với bất kỳ câu hỏi hay vấn đề
                                nào, cung cấp các giải pháp nhanh chóng và cá nhân hóa để đáp ứng nhu cầu của bạn.</p>
                            <div class="features-team-box mt-40">
                            ...
                            <div class="col-md-6">
                                <div class="contact-info-item">
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="text"><a href="mailto:support@gmail.com">Travio@gmail.com</a></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="col-lg-7">
                        <div class="comment-form bgc-lighter z-1 rel mb-30 rmb-55">
                            <form id="contactForm" class="contactForm" name="contactForm"
                                ...
                                <p>Địa chỉ email của bạn sẽ không được công bố, các trường bắt buộc được đánh dấu bằng dấu *
                                </p>
                                <div class="row mt-35">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="phone_number" name="phone_number"
                                                class="form-control" placeholder="Phone" value="" required
                                            ...
                                            <ul class="radio-filter mb-25">
                                                <li>
                                                    <input class="form-check-input" type="radio" name="terms-condition"
                                                        id="terms-condition">
                                                    <label for="terms-condition">Lưu tên, email và trang web của tôi trên
                                                        trình duyệt này để lần sau tôi bình luận.</label>
                                                </li>
                                            </ul>
