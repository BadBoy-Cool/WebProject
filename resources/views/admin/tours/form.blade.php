...
<div class="form-group">
    <label for="tour_ID">Mã Tour</label>
    <input type="text" name="tour_ID" class="form-control" value="{{ old('tour_ID', $tour->tour_ID ?? '') }}" required>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <input type="text" name="soluong" class="form-control" value="{{ old('soluong', $tour->soluong ?? '') }}">
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <input type="text" name="image" class="form-control" value="{{ old('image', $tour->image ?? '') }}">
</div>
